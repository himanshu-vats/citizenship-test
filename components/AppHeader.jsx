          ...
          {showBack && (
            <div className="absolute left-0">
              {onBackClick ? (
                <button
                  onClick={onBackClick}
                  className="inline-flex items-center text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white font-semibold text-sm transition-colors"
                >
